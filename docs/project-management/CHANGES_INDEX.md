# mydocs-mcp - Change Management Index
...
This file serves as the central index for all project changes. Each change is documented in detail in individual files located in the `changes/` directory.

**Change File Naming Convention**: `CHANGE-XXX-[brief-description].md`
